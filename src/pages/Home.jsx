    ...
    <section className="layout__crave">
      ...
      <div className="crave-container">
        <section className="cravings">
          <h1 onMouseEnter={() => refreshFlavor("exotic")}>
            Something <i>exotic</i>?{" "}
          </h1>
          <h1 onMouseEnter={() => refreshFlavor("random")}>
            Something <i>random?</i>{" "}
          </h1>
          <h1 onMouseEnter={() => refreshFlavor("nostalgic")}>
            Something <i>nostalgic?</i>{" "}
          </h1>
          <h1 onMouseEnter={() => refreshFlavor("tropical")}>
            Something <i>tropical?</i>{" "}
          </h1>
          <h1 onMouseEnter={() => refreshFlavor("classic")}>
            Something <i>classic?</i>{" "}
          </h1>
        </section>
  ...
  return (
    <section className="layout__newsletter">
      ...
      <div className="newsletter-container">
        ...
        <p>
          Get notified about discounts, new <br></br> flavors, freebies, and
          much more.
        </p>
      </div>
    </section>
